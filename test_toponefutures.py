"""
Test script for Top One Futures extractor
"""
...
from propfirm_scraper.extractors.toponefutures import TopOneFuturesExtractor
from propfirm_scraper.core.logger import setup_logger
from propfirm_scraper.config.schema import SiteConfig

logger = setup_logger()

async def test_toponefutures_extractor():
    """Test the Top One Futures extractor"""
    
    print("=" * 60)
    print("TESTING TOP ONE FUTURES EXTRACTOR")
    print("=" * 60)
    ...
    try:
        ...
        site_config = SiteConfig(
            ...
            url="https://toponefutures.com/",
            extractor_class="TopOneFuturesExtractor"
        )
        
        # Initialize extractor
        print("3. Initializing Top One Futures extractor...")
        extractor = TopOneFuturesExtractor(site_config)
        ...
        print("\n" + "=" * 60)
        print("TOP ONE FUTURES EXTRACTOR TEST COMPLETED")
        print("=" * 60)
...
if __name__ == "__main__":
    asyncio.run(test_toponefutures_extractor())