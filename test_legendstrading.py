"""
Test script for Legends Trading extractor
"""
...
from propfirm_scraper.extractors.legendstrading import LegendsTradingExtractor
from propfirm_scraper.core.logger import setup_logger
from propfirm_scraper.config.schema import SiteConfig

logger = setup_logger()

async def test_legendstrading_extractor():
    """Test the Legends Trading extractor"""
    
    print("=" * 60)
    print("TESTING LEGENDS TRADING EXTRACTOR")
    print("=" * 60)
    ...
    try:
        ...
        site_config = SiteConfig(
            ...
            extractor_class="LegendsTradingExtractor"
        )
        
        # Initialize extractor
        print("3. Initializing Legends Trading extractor...")
        extractor = LegendsTradingExtractor(site_config)
        ...
        print("\n" + "=" * 60)
        print("LEGENDS TRADING EXTRACTOR TEST COMPLETED")
        print("=" * 60)
...
if __name__ == "__main__":
    asyncio.run(test_legendstrading_extractor())