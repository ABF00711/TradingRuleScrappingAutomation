...
"""
Test script for Take Profit Trader extractor
"""
...
from propfirm_scraper.extractors.takeprofittrader import TakeProfitTraderExtractor
from propfirm_scraper.core.logger import setup_logger
from propfirm_scraper.config.schema import SiteConfig

logger = setup_logger()

async def test_takeprofittrader_extractor():
    """Test the Take Profit Trader extractor"""
    
    print("=" * 60)
    print("TESTING TAKE PROFIT TRADER EXTRACTOR")
    print("=" * 60)
    ...
    try:
        ...
        site_config = SiteConfig(
            ...
            extractor_class="TakeProfitTraderExtractor"
        )
        
        # Initialize extractor
        print("3. Initializing Take Profit Trader extractor...")
        extractor = TakeProfitTraderExtractor(site_config)
        ...
        print("\n" + "=" * 60)
        print("TAKE PROFIT TRADER EXTRACTOR TEST COMPLETED")
        print("=" * 60)
...
if __name__ == "__main__":
    asyncio.run(test_takeprofittrader_extractor())