"""
Test script for E8 Markets extractor
"""
...
from propfirm_scraper.extractors.e8markets import E8MarketsExtractor
from propfirm_scraper.core.logger import setup_logger
from propfirm_scraper.config.schema import SiteConfig

logger = setup_logger()

async def test_e8markets_extractor():
    """Test the E8 Markets extractor"""
    
    print("=" * 60)
    print("TESTING E8 MARKETS EXTRACTOR")
    print("=" * 60)
    ...
    try:
        ...
        # Create site config (using futures help center as configured)
        print("2. Creating site configuration...")
        site_config = SiteConfig(
            name="E8 Markets",
            url="https://helpfutures.e8markets.com/en/",
            extractor_class="E8MarketsExtractor"
        )
        
        # Initialize extractor
        print("3. Initializing E8 Markets extractor...")
        extractor = E8MarketsExtractor(site_config)
        ...
        print("\n" + "=" * 60)
        print("E8 MARKETS EXTRACTOR TEST COMPLETED")
        print("=" * 60)
...
if __name__ == "__main__":
    asyncio.run(test_e8markets_extractor())