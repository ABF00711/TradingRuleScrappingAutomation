"""
Test script for Trade Day extractor
"""
...
from propfirm_scraper.extractors.tradeday import TradeDayExtractor
from propfirm_scraper.core.logger import setup_logger
from propfirm_scraper.config.schema import SiteConfig

logger = setup_logger()

async def test_tradeday_extractor():
    """Test the Trade Day extractor"""
    
    print("=" * 60)
    print("TESTING TRADE DAY EXTRACTOR")
    print("=" * 60)
    ...
    try:
        ...
        site_config = SiteConfig(
            ...
            extractor_class="TradeDayExtractor"
        )
        
        # Initialize extractor
        print("3. Initializing Trade Day extractor...")
        extractor = TradeDayExtractor(site_config)
        ...
        print("\n" + "=" * 60)
        print("TRADE DAY EXTRACTOR TEST COMPLETED")
        print("=" * 60)
...
if __name__ == "__main__":
    asyncio.run(test_tradeday_extractor())