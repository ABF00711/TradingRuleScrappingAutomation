"""
Test script for The Trading Pit extractor
"""
...
from propfirm_scraper.extractors.thetradingpit import TheTradingPitExtractor
from propfirm_scraper.core.logger import setup_logger
from propfirm_scraper.config.schema import SiteConfig

logger = setup_logger()

async def test_thetradingpit_extractor():
    """Test The Trading Pit extractor"""
    
    print("=" * 60)
    print("TESTING THE TRADING PIT EXTRACTOR")
    print("=" * 60)
    ...
    try:
        ...
        site_config = SiteConfig(
            ...
            extractor_class="TradingPitExtractor"
        )
        
        # Initialize extractor
        print("3. Initializing The Trading Pit extractor...")
        extractor = TheTradingPitExtractor(site_config)
        ...
        print("\n" + "=" * 60)
        print("THE TRADING PIT EXTRACTOR TEST COMPLETED")
        print("=" * 60)
...
if __name__ == "__main__":
    asyncio.run(test_thetradingpit_extractor())